...
const CreatePoint = () => {
  ...
  function hanleInputChange(event: ChangeEvent<HTMLInputElement>) {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <fieldset>
          ...
          <div className='field'>
            ...
            <input type='text' name='name' id='name' onChange={hanleInputChange} />
          </div>

          <div className='field-group'>
            <div className='field'>
              <label htmlFor='email'>E-mail</label>
              <input type='email' name='email' id='email' onChange={hanleInputChange} />
            </div>
            <div className='field'>
              <label htmlFor='whatsapp'>Whatsapp</label>
              <input type='text' name='whatsapp' id='whatsapp' onChange={hanleInputChange} />
            </div>
          </div>
        </fieldset>
